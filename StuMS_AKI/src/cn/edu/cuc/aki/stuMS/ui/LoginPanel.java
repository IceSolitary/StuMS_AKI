...
public class LoginPanel extends JPanel implements ActionListener {
	...
	JButton loginButton = new JButton("LOGIN!!!! ©d(¨R¨Œ¨Q*)o");
	...
	public void actionPerformed(ActionEvent e) {
		...
		try {
			...
			JOptionPane.showMessageDialog(this, "ÄúÊäÈëµÄÕËºÅ»òÃÜÂë²»ÕýÈ·£¡", "µÇÂ¼Ê§°Ü", 0);
		} catch (IDNotExistException e1) {
			JOptionPane.showMessageDialog(this, "ÄúÊäÈëµÄID²»´æÔÚ£¡", "µÇÂ½Ê§°Ü", 0);
		}
	}
}
